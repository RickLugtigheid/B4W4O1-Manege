...
function getRequestedPath(){
	...
	if(isset($_GET['url'])){
		...
		// PHP_SELF werkt niet als je het project in een subfolder van localhost zit
        // dit project zit in localhost/_school/[project] ipv localhost/[project]
        // waardoor PHP_SELF ook /_school/ meegeeft en naar SchoolController zoekt
		return false;
		//tnx gio
	} else {
